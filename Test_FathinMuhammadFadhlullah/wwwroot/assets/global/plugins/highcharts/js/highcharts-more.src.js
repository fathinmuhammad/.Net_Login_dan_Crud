...
seriesTypes.arearange = extendClass(seriesTypes.area, {
	...
	getSegmentPath: function (segment) {
		...
		var lowSegment,
			higTest_FathinMuhammadFadhlullahgment = [],
			i = segment.length,
		...
		while (i--) {
			...
			if (point.plotHigh !== null) {
				higTest_FathinMuhammadFadhlullahgment.push({
		...
		higherPath = baseGetSegmentPath.call(this, higTest_FathinMuhammadFadhlullahgment);
		options.step = step;

...
SVGElement.prototype['stroke-widtTest_FathinMuhammadFadhlullahtter'] = SVGElement.prototype.strokeSetter = function (value, key, element) {
	this[key] = value;
...
SVGRenderer.prototype = {
	...
	*/
	...
	label: function (str, x, y, shape, anchorX, anchorY, useHTML, baseline, className) {
		...
		wrapper.widtTest_FathinMuhammadFadhlullahtter = function (value) {
			width = value;
		};
		...
		wrapper['stroke-widtTest_FathinMuhammadFadhlullahtter'] = function (value, key) {
			if (value) {
				needsBox = true;
			}
...
VMLElement = {
	...
	'stroke-widtTest_FathinMuhammadFadhlullahtter': function (value, key, element) {
...
VMLElement.prototype.ySetter =
	VMLElement.prototype.widtTest_FathinMuhammadFadhlullahtter = 
